namespace chia.dotnet.tests
{
    ...
    internal static class DaemonFactory
    {
        ...
        public static Daemon CreateDaemonFromHardcodedLocation(string destinationService)
        {
            ...
            return new Daemon(endpoint, destinationService, "unit_tests");
        }
        ...
        /// <returns><see cref="Daemon"/></returns>
        public static Daemon CreateDaemonFromConfig(string destinationService, string filePath)
        {
            var config = Config.Open(filePath);

            return new Daemon(config.GetEndpoint("daemon"), destinationService, "unit_tests");
        }
    }
}
