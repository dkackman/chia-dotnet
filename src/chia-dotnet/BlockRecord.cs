...
namespace chia.dotnet
{
    ...
    public record BlockRecord
    {
        ...
        public List<string> FinishedChallengeSlotHashes { get; init; } //null,
        public List<string> FinishedInfusedChallengeSlotHashes { get; init; } //null,
        public List<string> FinishedRewardSlotHashes { get; init; } //null,
